			...
			style="margin-left:140px;border:1px solid #e2e2e2;padding-left:10px;display:block;width:900px;">
				...
				<div style="float:left;width:400px;">
					<div style="text-align:center;margin-top:5px;margin-bottom:10px;">
						<span style="font-size:18pt;">아이디 찾기</span>
					</div>
					<div style="border-top:1px solid #e2e2e2;"></div>					
					<div style="margin-top:10px;">
						<form action="/buyer/test_search_idpw_check_id" method="get" target="searh_id_iframe">
							<table>
								<tr>
									<td style="text-align:right;width:120px;">
										생년월일
									</td>
									<td><input name="birth" style="width:150px;" type="text"></td>
								</tr>
							</table>
							<div style="text-align:center;padding:10px;">
								<input type="submit" value="확인해보기">
							</div>
							<div  style="display:none;position:absolute;">
								<iframe
									name="searh_id_iframe" 
									style="border:0px;">
								</iframe>
							</div>
						</form>
				...
				<div style="float:left;width:400px;">
					<div style="text-align:center;margin-top:5px;margin-bottom:10px;">
						<span style="font-size:18pt;">비밀번호 찾기</span>
					</div>
					<div style="border-top:1px solid #e2e2e2;"></div>					
					<div style="margin-top:10px;">
						<form action="/buyer/test_search_idpw_check_pw" method="get" target="searh_id_iframe">
							<table>
								<tr>
									<td style="text-align:right;width:120px;">
										아이디
									...
									<td>
										<input name="id" style="width:150px;" type="text">
									</td>
								</tr>
								<tr>
									<td style="text-align:right;width:120px;">
									...
									<td>
										<input name="birth" style="width:150px;" type="text">
									</td>
								</tr>
							</table>
							<div style="text-align:center;padding:10px;">
