...
function checkForm(){
	...
	else if($('#buyer_pw').val()==''){
		alert("비밀번호를 입력해주세요.");
	return false;
	}
	else if($('#buyer_birth').val()==''){
		alert("생년월일를 입력해주세요.");
	return false;
	}
	else if($('#buyer_adress').val()==''){
		alert("주소를 입력해주세요.");
	return false;
	}
	else if($('#buyer_phone').val()==''){
		alert("전화번호를 입력해주세요.");
	return false;
	}
	else if($('#buyer_mail').val()==''){
		alert("메일을 입력해주세요.");
	return false;
	}
							...
							<div id="body_right_div" style="background-color:white;">
								<div style="float:left;">
									<div style="border:2px solid #abcdef;padding:20px;margin-left:20px;">
										...
										<form method="post" action="/buyer/join" onsubmit="return checkForm();">
											<table>
												<tr>
													...
													<td>
														<input id="buyer_id" style="width:200px;"type="text" name="id">
													</td>
												</tr>
												<tr>
													<td style="width:100px;text-align:right;">
													...
													<td>
														<input id="buyer_pw" style="width:200px;"type="password" name="pw">
													</td>
												</tr>
												<tr>
													<td style="width:100px;text-align:right;">														
													...
													<td>
														<input id="buyer_birth" style="width:200px;"type="text" name="birth">
													</td>
												</tr>
												<tr>
													<td style="width:100px;text-align:right;">														
													...
													<td>
														<input id="buyer_adress" style="width:200px;"type="text" name="adress">
													</td>
												</tr>
												<tr>
													<td style="width:100px;text-align:right;">														
													...
													<td>
														<input id="buyer_phone" style="width:200px;"type="text" name="phone">
													</td>
												</tr>
												<tr>
													<td style="width:100px;text-align:right;">														
													...
													<td>
														<input id="buyer_mail" style="width:200px;"type="text" name="mail">
													</td>
												</tr>
											</table>	
											<div style="margin-left:200px;margin-top:20px;">
												<input type="submit" style="width:100px;" value="회원가입">
											</div>
										</form>
									</div>
								</div>
