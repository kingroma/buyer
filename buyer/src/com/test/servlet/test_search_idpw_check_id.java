...
/**
 * Servlet implementation class test_search_idpw_check_id
 */
@WebServlet("/test_search_idpw_check_id")
public class test_search_idpw_check_id extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public test_search_idpw_check_id() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Buyer> buyer_list = checkId(birth);
		
		String return_string = "";
		for ( int i = 0 ; i < buyer_list.size() ; i ++){
			return_string+="/ id : ["+buyer_list.get(i).getId()+"]";
		}
	...
	public ArrayList<Buyer> checkId(String birth){
