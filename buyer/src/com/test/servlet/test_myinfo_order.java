...
/**
 * Servlet implementation class test_myinfo_order
 */
@WebServlet("/test_myinfo_order")
public class test_myinfo_order extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public test_myinfo_order() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(order_num!=null|buyer_id!=null){
			...
			RequestDispatcher rd = request.getRequestDispatcher("/test/test_myinfo_order.jsp");
